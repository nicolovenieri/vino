...
<main class="w-full flex flex-col justify-center items-center bg-gray-500">
    <div class="mt-8 flex flex-row justify-between items-stretch">
        <p class="uppercase font-bold text-black text-xl"> <%if (languageString.equals("ita")){%>Vetrina<%}if (languageString.equals("eng")){ %>Showcase<% }%></p>
    </div>

    <div class="mt-8 flex flex-row justify-between items-stretch">
        <p class="uppercase font-medium text-black text-xl"> <%if (languageString.equals("ita")){%>Vini presenti in vetrina<%}if (languageString.equals("eng")){ %>Showcase's Wines<% }%></p>
