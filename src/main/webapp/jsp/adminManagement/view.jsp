    ...
    <main class="w-full flex flex-col justify-center items-center"  >
        <div class="my-6">
            ...
            <div class="order-1 mt-8 flex flex-row justify-between items-stretch w-auto">
                ...
                <%--                 Coupon                   --%>
            <div class="order-1 mt-8 flex flex-row justify-between items-stretch w-auto">
                <a class="bg-black hover:opacity-75 flex flex-row justify-between items-stretch w-auto rounded w-full uppercase py-4 px-6" href="javascript:couponManagementForm.requestSubmit()">
