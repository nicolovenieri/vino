                  ...
                  <section class="order-2 w-20 mt-4 flex flex-col flex-wrap w-32">
                      <div class="order-1 ml-4">
                          <div class="float ml-8">
                              <a href="javascript:AddToCart(<%=wishlist_tuples.get(i).getWine().getWineId()%>)" class="bg-gray-700 hover:bg-green-500 text-white font-bold rounded-full flex flex-row flex-no-wrap justify-center px-1 py-2 w-24 mb-4">
                              ...
                              <a href="javascript:RemoveFromWishlist(<%=wishlist_tuples.get(i).getWine().getWineId()%>)" class="bg-red-400 hover:bg-red-700 text-white font-bold rounded-full flex flex-row flex-wrap justify-center px-1 py-2 w-24">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><path class="heroicon-ui fill-current text-black mx-1" d="M8 6V4c0-1.1.9-2 2-2h4a2 2 0 012 2v2h5a1 1 0 010 2h-1v12a2 2 0 01-2 2H6a2 2 0 01-2-2V8H3a1 1 0 110-2h5zM6 8v12h12V8H6zm8-2V4h-4v2h4zm-4 4a1 1 0 011 1v6a1 1 0 01-2 0v-6a1 1 0 011-1zm4 0a1 1 0 011 1v6a1 1 0 01-2 0v-6a1 1 0 011-1z"/></svg>
                              </a>
                          </div>
                      </div>
                  </section>
