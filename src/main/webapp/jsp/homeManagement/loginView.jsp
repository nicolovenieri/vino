        ...
        <main class="flex flex-col justify-center items-center pb-8">
            ...
            <div class="px-8 pt-6 pb-8 mb-4 flex flex-col w-1/4">
                    <div class="mb-4">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" form="loginForm" id="username" name="username" type="text" placeholder="Username" maxlength="40" required>
                    </div>
                    <div class="mb-6">
