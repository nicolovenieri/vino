...
public class UserManagement {
    ...
    public static void view(HttpServletRequest request, HttpServletResponse response) {
        ...
        try     {
            ...
            List<User> users = usersRetrieve(daoFactory, sessionDAOFactory, request);
    ...
    private static List<User> usersRetrieve(DAOFactory daoFactory, DAOFactory sessionDAOFactory, HttpServletRequest request) {
